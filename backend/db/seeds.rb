defaults = {
  ...
  "strategy.supertrend.multiplier" => ["2.2", "float"],
  ...
  "strategy.trailing_stop_pct" => ["1.5", "float"],
  "strategy.timeframes.trend" => ["4h", "string"],
  "strategy.timeframes.confirm" => ["1h", "string"],
  ...
  "risk.simulated_capital_inr" => ["100000.0", "float"],
  ...
  "ai.ollama_timeout_seconds" => ["90", "integer"],
