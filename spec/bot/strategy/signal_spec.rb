...
RSpec.describe Bot::Strategy::Signal do
  subject(:signal) do
    described_class.new(symbol: "BTCUSDT", side: :long, entry_price: 45_000.0, candle_ts: 1_000_000)
  end
  ...
  it "returns true for short? on a short signal" do
    short_signal = described_class.new(symbol: "ETHUSDT", side: :short, entry_price: 3000.0, candle_ts: 2)
